...
int main(int argc, char* argv[])
{
    ...
    }
    {
        ...
        ASSERT_INT(rc, NVF_OK, 1, "Getting a str");
        ASSERT_INT(
            strcmp("multilinestr", str_out), 0, 1, "Comparing string results");
        ASSERT_INT(
            strlen("multilinestr") + 1, out_len, 1, "Comparing string lengths");
    }
    {
        char str_out[32] = { 0 };
        uintptr_t out_len = sizeof(str_out);
        ...
        ASSERT_INT(rc, NVF_OK, 1, "Getting a str");
        ASSERT_INT(
            strcmp("other test str", str_out), 0, 1, "Comparing string results");
    }
    {
        char bin_out[32] = { 0 };
        ...
        ASSERT_INT(
            memcmp(bin_exp, bin_out, bin_out_len), 0, 1, "Checking BLOB results");
    }
    {
        char bin_out[32] = { 0 };
        uintptr_t bin_out_len = sizeof(bin_out);
    ...
    ASSERT_INT(
        strcmp(tv_s.val.v_string, "str"), 0, 1, "Getting string value from array");
    ...
    ASSERT_INT(memcmp(tv_b.val.v_blob->data, b_exp_val, sizeof(b_exp_val)),
        0,
        1,
        "Getting blob value from array");
...

    {
        ...
        ASSERT_INT(strcmp(m_tv_s.val.v_string, "str2"),
            0,
            1,
    ...
    }
    {
        ...
        ASSERT_INT(bin_out_len, sizeof(bin_exp), 1, "Checking BLOB size");
        ASSERT_INT(
            memcmp(bin_exp, bin_out, bin_out_len), 0, 1, "Checking the blob value");
    ...
    }
    {
        ...
        ASSERT_INT(
            memcmp(str_exp, str_out, str_out_len), 0, 1, "Checking the string value");
    ...
    }
    {
        ...
        printf("Rendered map: (\n%s\n)\n", str_out);
        ASSERT_INT(
            str_len, strlen(str_out) + 1, 1, "Checking the output string length");
    ...
    ASSERT_INT(memcmp(&zero_root, &root, sizeof(zero_root)),
        0,
        1,
